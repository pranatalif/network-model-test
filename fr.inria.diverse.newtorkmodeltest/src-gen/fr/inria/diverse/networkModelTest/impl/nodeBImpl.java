 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.networkModelTest.impl.nodeBImpl#getNode <em>Node</em>}</li>
...
public class nodeBImpl extends MinimalEObjectImpl.Container implements nodeB
{
  ...
  public void setNode(String newNode)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, NetworkModelTestPackage.NODE_B__NODE, oldNode, node));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case NetworkModelTestPackage.NODE_B__NODE:
        return getNode();
